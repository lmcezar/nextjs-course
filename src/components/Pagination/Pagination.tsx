      ...
      {pages.map((page) => {
        ...
        if (isEllipsis) {
          return (
            ...
            >
              <span className="flex h-10 items-center justify-center bg-slate-700 hover:bg-indigo-400/20 px-4 hover:text-slate-300">
                ...
              </span>
            </li>
          );
        ...
        return (
          ...
          >
            <Link
              className={cn(
                "flex h-10 items-center justify-center bg-slate-700 hover:bg-indigo-400/20 px-4 hover:text-slate-300",
                {
